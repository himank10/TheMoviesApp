...
import com.example.himank.themoviesapp.fragment.HomeMovieFragment;
import com.example.himank.themoviesapp.fragment.HomeTvFragment;
...
public class HomeActivity extends BaseActivity {
    ...
    @BindView(R.id.rotate_reel)
    ImageView rotateReel;

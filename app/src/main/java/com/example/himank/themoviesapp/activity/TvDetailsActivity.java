...
import com.example.himank.themoviesapp.TheMoviesAppContextWrapper;
import com.example.himank.themoviesapp.model.TV;
import com.example.himank.themoviesapp.model.Video;
import com.example.himank.themoviesapp.model.VideoResults;
import com.example.himank.themoviesapp.provider.MovieContract;
import com.example.himank.themoviesapp.service.ServiceGenerator;
import com.example.himank.themoviesapp.service.TvService;
import com.example.himank.themoviesapp.util.AppUtils;
import com.example.himank.themoviesapp.util.Constants;
import com.example.himank.themoviesapp.util.ContentValuesUtils;
import com.example.himank.themoviesapp.util.PrefUtils;
...
public class TvDetailsActivity extends AppCompatActivity {
    ...
    private static final String TV_ID = "com.example.himank.themoviesapp.details.tv_id";

    private Cursor mCursor;
    private ContentResolver mResolver;
    private String mId;

    @BindDrawable(R.drawable.ic_launcher_foreground) Drawable placeholderImage;
    @BindView(R.id.toolbar)
    Toolbar mToolbar;
    @BindView(R.id.tv_details_backdrop)
    ImageView backdrop;
    ...
    @BindView(R.id.tv_details_video_layout_root)

package com.example.himank.themoviesapp.adapter;
...
import com.example.himank.themoviesapp.activity.MovieDetailsActivity;
...
public class HomeMovieAdapter extends RecyclerView.Adapter<HomeMovieAdapter.MovieHolder> {
    ...
    public class MovieHolder extends RecyclerView.ViewHolder {
        ...
        void bindMovie(Movie movie) {
            ...
            Drawable placeholder = ResourcesCompat.getDrawable(mContext.getResources(), R.drawable.ic_launcher_foreground, null);
